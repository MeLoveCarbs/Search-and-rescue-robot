...
void left(float ang, float speed)
{
  ...
  targetTicks = leftReverseTicksTurns + 1.05*deltaTicks;
...
void right(float ang, float speed)
{
  ...
  targetTicks = rightReverseTicksTurns + 2*deltaTicks;
...
void loop() {
  ...
  //check if forwardDistance has exceeded newDist, in which case we stop
  if (deltaDist > 0)
  {
    if (dir == FORWARD)
    {
    ...
    Serial.print(rightReverseTicksTurns);
    Serial.print(" ");
